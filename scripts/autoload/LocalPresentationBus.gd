...
signal siming_staging_requested(payload)
...
signal embodied_pickup_result_received(payload)
signal embodied_inventory_stow_result_received(payload)
signal embodied_inventory_retrieve_result_received(payload)
signal websocket_session_bound_received(payload)
signal websocket_session_revoked_received(payload)
signal websocket_session_renewal_enrollment_received(payload)
signal gameplay_runtime_state_projection_received(payload)
signal gameplay_mirror_delivery_received(payload)
signal gameplay_mirror_resync_required_received(payload)
signal stormnight_case_projection_received(payload)
signal government_drought_advisory_projection_received(payload)
signal government_drought_advisory_delivery_received(payload)
signal embodied_phase_event_emitted(payload)
signal embodied_local_outcome_emitted(payload)
signal embodied_presentation_observed_emitted(payload)
signal embodied_resync_request_emitted(payload)
signal archive_door_request_registered(payload)
