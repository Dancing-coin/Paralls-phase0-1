...
def evaluate_backend_contract(project_root: Path) -> dict[str, object]:
    ...
    authority_event_tests = project_root / "backend" / "tests" / "test_authority_event_bus.py"
    ...
    results = [
        ...
        _result(
            ...
            and _contains(
                ...
                [
                    "test_authority_event_rejects_forbidden_public_envelope_fields",
                    "test_in_memory_bus_publishes_deep_copies_to_subscribers_and_store",
                    "test_in_memory_bus_filters_events_by_room_and_type",
                ],
            ),
            ["backend/app/models/authority_event.py", "backend/tests/test_authority_event_bus.py"],
        ),
        _result(
