...
def main() -> int:
    ...
    report = {"overall_passed": result.returncode == 0 and godot_ok, "focused_pytest_passed": result.returncode == 0, "godot_runtime_verified": godot_ok, "pytest_log": str(log), "godot_log": str(godot_log), "desktop_log": str(desktop_log), "godot_artifact": str(godot_artifact)}
