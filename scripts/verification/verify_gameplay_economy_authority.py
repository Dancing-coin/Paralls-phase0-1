...
def main() -> int:
    parser=argparse.ArgumentParser(); parser.add_argument("--python-exe",default=None); args=parser.parse_args(); root=repo_root(); log=verification_dir(root)/"gameplay-economy-authority-pytest.log"
