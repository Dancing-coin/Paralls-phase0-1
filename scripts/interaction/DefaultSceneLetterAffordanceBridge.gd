...
@export var semantic_tags := PackedStringArray(["letter", "inspectable", "readable", "destroyable"])
@export var policy_ref := "authority_policy:esm_inspect_letter:v1"
@export var supported_interaction_types := PackedStringArray(["inspect", "read", "destroy"])
