    ...
    def derive(
        ...
        *,
        ...
        for projection in sorted(read_set.projections, key=lambda item: (_projection_actor(item), item.ref)):
            ...
            objective = kind in {"schedule_gated_supply", "organization_production_work_contribution"} or bool(payload.get("objective_effect")) or bool(payload.get("world_effect"))
