...
def filter_candidate_for_actor(
    ...
    *,
    ...
    return CharacterPerceivedEvent(
        ...
        capture_root_id=candidate.capture_root_id,
        capture_id=candidate.capture_id,
        clock_domain=candidate.clock_domain,
        monotonic_tick=candidate.monotonic_tick,
        source_frame_index=candidate.source_frame_index,
        wall_clock_ts=candidate.wall_clock_ts,
        sample_ref_id=candidate.sample_ref_id,
        world_anchor_id=candidate.world_anchor_id,
        subject_ref=candidate.subject_ref,
        target_ref=candidate.target_ref,
        source_ref_lineage=list(candidate.source_ref_lineage),
