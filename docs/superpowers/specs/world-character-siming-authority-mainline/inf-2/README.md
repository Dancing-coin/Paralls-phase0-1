...
32. [INF-2AB tax payment owner-contract audit](2026-08-17-inf-2ab-tax-payment-owner-contract-audit.md) - blocked: a canonical treasury account/account-holder and tax-payment event/receipt contract do not exist; INF-2Z remains terminal-only and account-neutral.
