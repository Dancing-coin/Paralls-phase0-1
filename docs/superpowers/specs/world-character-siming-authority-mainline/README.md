...
5. [phase-three-population-continuity/README.md](</d:/Users/User/Documents/paralls-phase-0-demo/docs/superpowers/specs/world-character-siming-authority-mainline/phase-three-population-continuity/README.md>)
   - [2026-09-16 character-population unified runtime target](2026-09-16-character-population-simulation-unified-runtime-design.md) - approved B0-B3, simple-module, universal-codebook and protocol-driven social-simulation target; implementation remains unplanned
   - [2026-09-16 角色与群体模拟统一运行时设计（中文版）](2026-09-16-角色与群体模拟统一运行时设计-中文版.md) - 设计意图、数据边界、INF 分层、密码本、B0-B3 交接和农民洪灾样板
