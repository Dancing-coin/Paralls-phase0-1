...
The first complete reference case using this extension is specified in
...
their own truth boundaries. Its completion audit records the four-outcome,
replay, owner-handoff and second-content-variant evidence.
