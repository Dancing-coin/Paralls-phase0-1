...
- [ ] **Step 3: Implement the reusable scene and script**
...
- [ ] **Step 5: Commit the isolated character slice**
...
- [ ] **Step 1: Add a failing instance-count assertion**
...
- [ ] **Step 2: Implement four neutral profiles**
...
- [ ] **Step 3: Implement rejection rollback**
...
- [ ] **Step 4: Run headless Godot and static tests**
...
- [ ] **Step 5: Commit the Stormnight character binding**
...
- [ ] **Step 1: Add tests for committed-state-only animation**
...
- [ ] **Step 2: Implement deterministic state mapping**
...
- [ ] **Step 4: Commit the action presentation contract**
